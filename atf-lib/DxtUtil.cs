...
internal static class DxtUtil
{
    ...
    internal static byte[] DecompressDxt1Sep(byte[] dxt1Data, byte[] dxt1ImageData, int width, int height)
    {
    ...
    private static void DecompressDxt1BlockImpl(ushort c0, ushort c1, uint lookupTable, int x, int y, int width,
        int height, byte[] imageData)
    {
        byte r0, g0, b0;
        byte r1, g1, b1;
